...
import time,sys
questions={q1:'b',q2:'a',q3:'b',q4:'d',q5:'c'}
...
for i in questions:
    ...
    if skip=='y':
        ...
        skip_time=t5-t3
        print('time taken to skip this question is:',skip_time,'seconds')
        continue
    ...
    qt=t4-t3
    print('time taken to answer this question is:',qt,'seconds')

t2=time.perf_counter()
t=t2-t1
print('---------Here is your result---------------------')
print('Your total time taken to finish this quiz:',t,'seconds')
